      ...
      <el-form :model="form" label-width="100px" class="contract-form">
        <div class="form-section">
          ...
          <div class="form-grid">
            ...
            <el-form-item label="合同标题" required><el-input v-model="form.title" placeholder="例如：2026年算力租赁协议" /></el-form-item>
        ...
        <div class="form-section">
          <div class="form-section__title">时间配置</div>
          <div class="form-grid">
...
const form = reactive({
  ...
  amount: 0, start_date: '', end_date: '', status: 'draft', description: ''
})
...
const handleSave = async () => {
  ...
  try {
    ...
    else { const res: any = await createContract(form); router.push(`/contracts/compute/${res.id}`) }
    ElMessage.success('保存成功')
    router.push('/contracts/compute')
...
.form-actions { margin-top: var(--spacing-xl); padding-top: var(--spacing-lg); border-top: 1px solid var(--color-border-light); display: flex; gap: var(--spacing-sm); justify-content: flex-end; }
</style>